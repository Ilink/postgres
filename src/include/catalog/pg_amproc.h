...
DATA(insert (   1976   21 21 3 5000 ));
DATA(insert (   1976   23 23 3 5001 ));
DATA(insert (   1976   20 20 3 5002 ));
DATA(insert (   1976   700 700 3 5003 ));
DATA(insert (   1976   701 701 3 5004 ));
DATA(insert (	1976   21 21 4 5005 ));
DATA(insert (	1976   23 23 4 5006 ));
DATA(insert (	1976   20 20 4 5007 ));
DATA(insert (	1976   700 700 4 5008 ));
DATA(insert (	1976   701 701 4 5009 ));
